    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="javascript:void(0)" class="d-lg-none">
                <img alt="Logo" src="<?php echo e(asset('assets/media/logos/logo-black-144×30.png')); ?>" class="h-30px" />
            </a>
        </div>
        <!--end::Mobile logo-->
        <!--begin::Wrapper-->
            ...
            <div class="d-flex align-items-stretch flex-shrink-0">
                                ...
                                <div class="d-flex flex-column px-9">
                                    ...
                                    <div class="text-center px-4">
                                        <img class="mw-100 mh-200px" alt="image"
                                            src="<?php echo e(asset('assets/media/illustrations/sketchy-1/1.png')); ?>" />
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                                <!--end::Wrapper-->
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click"
                        ...
                        <?php if(getLoggedInUserInfo('logged_session_data.profile_img')): ?>
                            <img alt="Logo"
                                src="<?php echo e(asset('uploads/user/profile/' . getLoggedInUserInfo('logged_session_data.profile_img'))); ?>" />
                        <?php else: ?>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                            ...
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="fw-bolder d-flex align-items-center fs-5">
                                        <?php echo e(getLoggedInUserInfo('logged_session_data.full_name')); ?>

                                    </div>
                                    <a href="javascript:void(0)"
                                        class="fw-bold text-muted text-hover-primary fs-7 text-break"><?php echo e(getLoggedInUserInfo('logged_session_data.email')); ?></a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
                        ...
                        <div class="menu-item px-5">
                            <a href="<?php echo e(route('user.profile.viewProfile')); ?>" class="menu-link px-5">My Profile</a>
                        </div>
                        <!--end::Menu item-->
                        ...
                        <div class="menu-item px-5 my-1">
                            <a href="<?php echo e(route('user.profile.changePassword')); ?>" class="menu-link px-5">Change
                                Password</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu separator-->
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a href="<?php echo e(route('user.logout')); ?>" class="menu-link px-5">Sign Out</a>
                        </div>
                        <!--end::Menu item-->
                    </div>
...
<?php /**PATH D:\xampp\htdocs\abs\resources\views/layout/header.blade.php ENDPATH**/ ?>