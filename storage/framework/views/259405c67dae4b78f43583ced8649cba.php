<?php $__env->startSection('title', 'Request WhiteList'); ?>
...
<?php $component = App\View\Components\ToolbarComponent::resolve(['title' => 'Requests WhiteList','breadcrumbs' => [
        ['label' => 'Home', 'url' => route('dashboard')],
        ['label' => 'Order Management', 'url' => 'javascript:void(0)'],
        ['label' => 'Requests WhiteList', 'active' => true],
    ],'modalTarget' => 'openWhitelistModal','actionIcon' => 'fas fa-plus-circle','actionLabel' => 'Create'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
            ...
            <?php echo $__env->make('marchant.requestWhitelist.modal.addWhitelistModal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\abs\resources\views/marchant/requestWhitelist/index.blade.php ENDPATH**/ ?>