...
<?php $component = App\View\Components\ToolbarComponent::resolve(['title' => 'Dashboard','breadcrumbs' => [['label' => 'Home', 'url' => route('dashboard')], ['label' => 'Dashboard', 'active' => true]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
        ...
        <div id="kt_content_container" class="container-fluid">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('dashboard.admin')): ?>
                <div class="row g-5 g-xl-8">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('marchant.balance.request.approve.index')): ?>
                        <div class="col-xl-3">
                            ...
                            <a href="javascript:void(0)" class="card bg-danger hoverable card-xl-stretch mb-xl-8">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="fw-bold text-white"><?php echo e($pending_order); ?></div>
                                </div>
                                <!--end::Body-->
                            </a>
                        ...
                        <div class="col-xl-3">
                            ...
                            <a href="/marchant/all/balance/request" class="card bg-primary hoverable card-xl-stretch mb-xl-8">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="fw-bold text-white"><?php echo e($pending_request); ?></div>
                                </div>
                                <!--end::Body-->
                            </a>
                            <!--end::Statistics Widget 5-->
                        ...
                        <div class="col-xl-3">
                            ...
                            <a href="javascript:void(0)" class="card bg-success hoverable card-xl-stretch mb-5 mb-xl-8">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="fw-bold text-white"><?php echo e($pending_transfer); ?></div>
                                </div>
                                <!--end::Body-->
                            </a>
                            <!--end::Statistics Widget 5-->
                        ...
                        <div class="col-xl-3">
                            ...
                            <a href="/marchant/all/whitelist/request" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="fw-bold text-white"><?php echo e($pending_whitelist); ?></div>
                                </div>
                                <!--end::Body-->
                            </a>
                            <!--end::Statistics Widget 5-->
            ...
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('dashboard.distributor')): ?>
                <div class="post d-flex flex-column-fluid" id="kt_post">
                    <!--begin::Container-->
                    <div id="kt_content_container" class="container-fluid">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body p-0 position-relative">
                                <img src="<?php echo e(asset('assets/media/background/background8.jpg')); ?>"
                            ...
                            <div class="card-body text-center mt-10">
                                <h3 class="fw-bold text-gray-800"> <?php echo e(getLoggedInUserInfo('logged_session_data.full_name')); ?>

                                </h3>
                                <p class="text-muted"><?php echo e(getLoggedInUserInfo('logged_session_data.email')); ?></p>
                                ...
                                <div class="row mt-10">
                                    ...
                                    <div class="col">
                                        <h4 class="fw-bold">
                                            <?php if(isset($user_diamond->current_balance)): ?>
                                                <?php echo e($user_diamond?->current_balance); ?>
                        ...
                        <div class="row mt-5 mb-10">
                            <div class="col-md-4">
                                <a href="<?php echo e(route('marchant.order.balance.index')); ?>"
                            ...
                            <div class="col-md-4">
                                <a href="<?php echo e(route('marchant.balance.request.index')); ?>"
                            ...
                            <div class="col-md-4">
                                <a href="<?php echo e(route('marchant.transfer.balance.index')); ?>"
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\abs\resources\views/dashboard/index.blade.php ENDPATH**/ ?>