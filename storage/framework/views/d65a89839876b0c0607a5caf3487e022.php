...
<?php $component = App\View\Components\ToolbarComponent::resolve(['title' => 'User List','breadcrumbs' => [
        ['label' => 'Home', 'url' => route('dashboard')],
        ['label' => 'User Management', 'url' => 'javascript:void(0)'],
        ['label' => 'Access Control', 'url' => 'javascript:void(0)'],
        ['label' => 'User List', 'active' => true],
    ],'modalTarget' => 'openUserModal','actionIcon' => 'fas fa-plus-circle','actionLabel' => 'Add New'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
            ...
            <?php echo $__env->make('user.modal.addUserModal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            

            
            <?php echo $__env->make('user.modal.changeUserPasswordModal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startSection('page_script'); ?>
    ...
    <script src="<?php echo e(asset('assets/custom/js/user/index.js')); ?>"
        <?php echo e(Sri::html('assets/custom/js/user/index.js')); ?>></script>
    <!--end::Page Custom Stylesheets(used by this page)-->

<?php $__env->stopSection(); ?>

<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\abs\resources\views/user/index.blade.php ENDPATH**/ ?>