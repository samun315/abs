<?php $__env->startSection('title', 'Manual Gateway'); ?>
...
<?php $component = App\View\Components\ToolbarComponent::resolve(['title' => 'Manual Gateway list','breadcrumbs' => [
        ['label' => 'Home', 'url' => route('dashboard')],
        ['label' => 'Wallet Management', 'url' => 'javascript:void(0)'],
        ['label' => 'Manual Gateway list', 'active' => true],
    ],'modalTarget' => 'openGatewayModal','actionIcon' => 'fas fa-plus-circle','actionLabel' => 'Create'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
            ...
            <?php echo $__env->make('payment.paymentGateway.modal.addGatewayModal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            

                
                <?php echo $__env->make('payment.paymentGateway.modal.detailsModal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startSection('page_script'); ?>
    ...
    <script src="<?php echo e(asset('assets/plugins/custom/ckeditor/ckeditor-classic.bundle.js')); ?>"
        <?php echo e(Sri::html('assets/plugins/custom/ckeditor/ckeditor-classic.bundle.js')); ?>></script>
        
    <!-- begin::Page Custom Stylesheets(used by this page) -->
    <script src="<?php echo e(asset('assets/custom/js/payment/paymentGateway/index.js')); ?>"
        <?php echo e(Sri::html('assets/custom/js/payment/paymentGateway/index.js')); ?>></script>
    <!--end::Page Custom Stylesheets(used by this page)-->

<?php $__env->stopSection(); ?>

<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\abs\resources\views/payment/paymentGateway/index.blade.php ENDPATH**/ ?>