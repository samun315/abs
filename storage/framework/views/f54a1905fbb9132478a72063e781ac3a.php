...
<?php $component = App\View\Components\ToolbarComponent::resolve(['title' => 'Order List','breadcrumbs' => [
        ['label' => 'Home', 'url' => route('dashboard')],
        ['label' => 'Order Management', 'url' => 'javascript:void(0)'],
        ['label' => 'Order List', 'active' => true],
    ],'actionUrl' => ''.e(route('marchant.order.balance.create')).'','actionIcon' => 'fas fa-plus-circle','actionLabel' => 'Add Balance'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
            ...
            <?php echo $__env->make('marchant.order.modal.showOrderModal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\abs\resources\views/marchant/order/index.blade.php ENDPATH**/ ?>